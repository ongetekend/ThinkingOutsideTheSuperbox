...
triples = [('../data/spongent-differential-superbox-unrounded.txt', '-', 'r', 'Differentials'), 
	   ('../data/spongent-differential-trail-superbox.txt', '-', 'b', 'Differential Trails')]
...
plt.savefig('differential_spongent_superbox_unrounded.pdf', bbox_inches='tight')
