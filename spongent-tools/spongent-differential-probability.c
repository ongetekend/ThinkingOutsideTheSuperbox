...
main(void)
{
	...
	table_fixed_print("data/spongent-differential-superbox.txt", number_of_differentials_superbox);

	Table_fixed *number_of_differentials_full = convolve_tables_fixed(number_of_differentials_superbox, NUMBER_OF_SUPERBOXES, 0, 0);

	table_fixed_print("data/spongent-differential-full.txt", number_of_differentials_full);
